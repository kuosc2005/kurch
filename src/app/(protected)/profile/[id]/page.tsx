...
export default function ProfilePage() {
  const [activeTab, setActiveTab] = useState<"Publications" | "Projects">(
    "Publications"
  );
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                ...
                Environmental Science at Kathmandu University. His research
                primarily focuses on climate change impacts on mountain
                ecosystems, with a particular emphasis on glacial retreat in the
                Himalayas.
              </p>
            </div>
