...
export default function Hero() {
  return (
    <section className="relative py-16 sm:py-20 md:py-24 h-[55rem] flex flex-col justify-center items-center lg:py-32 bg-gradient-to-b from-white via-[f5f5f5] to-[#025C62]/20 overflow-hidden">
      <div className="container relative px-4 sm:px-6 lg:px-8 xl:px-20 mx-auto ">
          ...
          <div className="flex flex-col justify-center space-y-6 sm:space-y-8 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
              <Link href="/login" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  className="w-full sm:w-auto bg-[#025C62] cursor-pointer hover:bg-[#025C62]/80 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 group px-6 py-3 sm:px-8 sm:py-4"
                >
                  Get Started
